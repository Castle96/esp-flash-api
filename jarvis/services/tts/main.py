...
Voices (kokoro):
  bm_george  British male, authoritative  <- default / recommended for Jarvis
...
app = FastAPI(title="Jarvis TTS Service", version="1.0.0", lifespan=lifespan)
