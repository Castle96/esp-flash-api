...
# ---------------------------------------------------------------------------
# Remote wake word microservice (big machine port 8003)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Gitea server (k8s NodePort on salamence)
# ---------------------------------------------------------------------------
GITEA_URL = os.getenv("GITEA_URL", "http://192.168.5.184:30529")
GITEA_ENABLED = os.getenv("GITEA_ENABLED", "true").lower() == "true"
GITEA_TOKEN = os.getenv("GITEA_TOKEN", "")
GITEA_ADMIN_USER = os.getenv("GITEA_ADMIN_USER", "admin")
GITEA_ADMIN_PASS = os.getenv("GITEA_ADMIN_PASS", "admin123!")
